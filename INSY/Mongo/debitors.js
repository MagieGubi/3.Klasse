...
db.debitors.insertMany([
{
     ...
     fundings : [ {
          ...
          transferredAt : ISODate("2012-06-30T00:00:00Z")
...
},
{
     ...
     fundings : [ {
          ...
          transferredAt : ISODate("2012-03-30T00:00:00Z")
         
     }, {
          project_id    : ObjectId("5c2dfad77d1c229482d0dd9c"),
          projectName   : "Transaktionsverfahren in NoSQL Datenbanken",
          amount        : NumberLong(300000), 
          transferredAt : ISODate("2017-09-10T00:00:00Z")
     ...
     fundings : [ {
          ...
          transferredAt : ISODate("2017-09-13T00:00:00Z")  
     }, {
          project_id    : ObjectId("5c2dfad77d1c229482d0dd9e"),
          projectName   : "Motorensimulation",
          amount        : NumberLong(300000), 
          transferredAt : ISODate("2018-11-01T00:00:00Z")  
     }  
     ]
},{
